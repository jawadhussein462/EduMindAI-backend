...
from api.data_pipeline.loaders.data_loader import DataLoader
from api.data_pipeline.parsers.basic_parser import SimpleAzurePDFParser
from api.data_pipeline.chunkers.chunker import Chunker
...
class ExamDataPipeline:
    ...
    def __init__(self, config: AppConfig, max_concurrency: int = 10):
        ...
        self.pdf_parser = SimpleAzurePDFParser(config)
    ...
    async def _process_exam_files_async(self) -> None:
        ...
        parsing_dir = os.path.join(base_dir, "logs", "parsed_data")
        chunking_dir = os.path.join(base_dir, "logs", "chunked_data")
